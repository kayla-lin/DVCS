...
pub mod user_interaction{
    ...
    pub fn diff_in(file_path: String, head: String) -> bool{
        ...
        match res {
            true => {
                ...
                stager::stager::diff(file_path, head);
                return true;
            },
            false => {
                println!("Error!");
    ...
    pub fn status_in(file_path: String) -> bool{
        ...
        match res {
            true => {
                ...
                let status_res = stager::stager::status(file_path);
                if status_res.is_ok(){
                    return true;
                }else {
    ...
    pub fn remove_in(file_path: String) -> bool{    
        let res: bool = stager::stager::remove(file_path);
        if res {return true; }
        return false;

    }
    pub fn add_in(file_path: String) -> bool{
        let res: bool = stager::stager::add(file_path);
        if res {return true; }
        return false;
    }
